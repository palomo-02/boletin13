...
public class App {
	...
	public static void main(String[] args) {
		...
		socios.add(new Socio("Ana", "74839203P", LocalDate.of(1992, 12, 5), LocalDate.of(2019, 8, 15), 2000, 1));
		socios.add(new Socio("Juan", "23654789X", LocalDate.of(1997, 3, 11), LocalDate.of(2021, 9, 1), 1600, 4));
