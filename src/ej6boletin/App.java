...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("filtrado por dinero : ");

		socios.stream().filter(Socio->Socio.getCouta()>100).forEach(System.out::println);
		...
		socios.stream().filter(Socio->Socio.getNombre().startsWith("A")).forEach(System.out::println);
		System.out.println("--------------------------------------------------------------------------- ");
